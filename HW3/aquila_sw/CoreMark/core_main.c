...
{
#endif
    ee_printf("coremark initializing ... ");
...
#error "Please define a way to initialize a memory block."
    ...
    /* Data init */
    /* Find out how much space we have based on the number of algorithms */
    ...
    ee_printf("executing, wait about 10 seconds ...\n\n");
    start_time();
#if (MULTITHREAD > 1)
    ...
    if (time_in_secs(total_time) > 0)
        ee_printf("Iterations/Sec   : %d\n",
                  ...
                  / time_in_secs(total_time));
#endif
    if (ITERATIONS != 1 && time_in_secs(total_time) < 10)
    {
